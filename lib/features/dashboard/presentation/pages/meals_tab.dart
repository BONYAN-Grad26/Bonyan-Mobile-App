  ...
  Widget _buildProgressRow(BuildContext context, String label, double current, double target, String suffix, Color accent) {
    ...
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 8),
        LinearProgressIndicator(value: progress.clamp(0.0, 1.0), backgroundColor: accent.withValues(alpha: 0.1), color: accent, minHeight: 8, borderRadius: BorderRadius.circular(9)),
      ],
    );
  }
}
